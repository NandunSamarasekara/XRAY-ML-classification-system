...
OUTPUT_DIR = BASE_PATH / "ml" / "members" / "member6_vit" / "processed"
...
target_classes = [
    ...
    'Pneumonia', 'Mass', 'Pneumothorax']

# Filter the dataframe
print(f"Filtering for classes: {target_classes}")
df = df[df['Finding Labels'].isin(target_classes)].reset_index(drop=True)
